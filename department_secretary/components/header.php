...
{
    if($_SESSION['role']!="department_secretary")
    {
        echo '<script>
...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3 ">
            ...
            <a href="subjectsettings.php" class="subjectsettings flex items-center rounded-lg opacity-75 text-white py-3 hover:opacity-100  m-2 pl-4 nav-item">
                <i class="material-icons  mr-3">groups</i>
                Subject Settings
            </a>
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header class="w-full items-center bg-white py-3 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div style="z-index:99999" x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
