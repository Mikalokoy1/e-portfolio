...
$(document).ready(function() {
  // Hide department section initially
  $('#faculty_dep').hide();

  // Department visibility toggle
  $('#facultyPosition').change(function() {
    ...
    if (position === "department_secretary" || position === "department_chairperson") {
      ...
      $.ajax({
        url: 'controller/get_department.php',
        type: 'POST',
  ...
  document.getElementById('submitFaculty').addEventListener('click', function(e) {
    if (!validateBirthday()) {
      e.preventDefault();
      return false;
    }
