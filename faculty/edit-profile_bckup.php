<?php include '1components/header.php'?>
<?php 
$user_id = $_SESSION['id'];
        ...
        <div class="flex">
            <button type="submit" class="bg-green-700  text-white btnSaveProfile py-2 px-4 rounded-lg font-semibold hover:bg-green-500  transition">
                Save Changes
                    ...
                    <div  class="grid p-3  gap-x-10  lg:grid-cols-2">
                        ...
                        <div style="height:500px" class="card bg-white items-center flex flex-col shadow-md rounded-lg p-10 ">
                                ...
                                <div class="grid w-full ">
                                    <p class="text-sm text-right ">
                                        <a href="#" id="modalUploadBtn" class="bg-orange mt-3 text-center w-full text-orange px-3 py-4 rounded-full shadow-lg transform transition-transform duration-200 hover:scale-105 hover:shadow-xl hover:bg-orange-600">Upload</a>
                                    </p>
                                </div>
                        </div>
                    </div>
                ...
                <div class="overflow-y-scroll px-4 lg:mt-0 mt-3 pb-4" style="height:500px ">
