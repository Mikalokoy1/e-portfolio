...
function uicard($card_number,$image,$name,$position,$specialization,$contacts,$icon)
{
    ...
    <tr>
        <td width="120px" data-card="'.$card_number.'" class="toggle-btn2 px-4 cursor-pointer text-center md:text-left" colspan="1" style="font-size:8px;">' . $name . '</td>
        <td rowspan="4" data-card="'.$card_number.'" class="toggle-btn2 px-4 cursor-pointer  text-center " style="font-size:8px;">
            ' . $icon . '
        </td>
    </tr>
    <tr>
        <td colspan="1" data-card="'.$card_number.'" class="toggle-btn2 px-4 cursor-pointer text-center md:text-left" style="font-size:8px;">' . $position . '</td>
    </tr>
    <tr>
        <td colspan="1" data-card="'.$card_number.'" class="toggle-btn2 px-4 cursor-pointer text-center md:text-left" style="font-size:8px;">' . $specialization . '</td>
    </tr>
    <tr>
        <td colspan="1" data-card="'.$card_number.'" class="toggle-btn2 px-4 cursor-pointer text-center md:text-left" style="font-size:8px;">' . $contacts . '</td>
    </tr>';
