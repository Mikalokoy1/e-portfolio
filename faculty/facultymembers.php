<?php include 'components/header.php'?>
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                {
                card($college_dean_type,'college_dean',$college_dean_image,$college_dean_name,$college_dean_specialization,$college_dean_phone,$college_dean_id,$my_college_id,$my_college_id);
                }  
                    //    DEPARTMENT SECRETARY
                if($college_secretary_name!="xx")
                {
                    card($college_secretary_type,'college_secretary',$college_secretary_image,$college_secretary_name,$college_secretary_specialization,$college_secretary_phone,$college_secretary_id,$my_college_id,$my_college_id);
                }
                ...
                foreach ($rows as $row) {
                    ...
                    $only_my_codepartment = '';
                    if($department_id == $my_department_id)
                    {
                        $only_my_codepartment = '<a href="facultymembers-info.php?i='.$row['id'].'" class="bg-orange mt-3 text-center w-full text-orange px-1 py-2 rounded-full shadow-lg transform transition-transform duration-200 hover:scale-105 hover:shadow-xl hover:bg-orange-600">
                            View
                        </a>';
                    }else{
                      $only_my_codepartment = '';
