...
{
    if($_SESSION['role']!="college_secretary")
    {
        echo '<script>
...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-2">
            <a href="departments.php" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">
        ...
        <nav class="text-white text-base font-semibold pt-3 ">
            <a href="departments.php" class="departments flex items-center text-white opacity-75 hover:opacity-100 py-3 m-2 rounded-lg  pl-4 nav-item">
            ...
            <a href="settings.php" class="settings flex items-center text-white opacity-75 hover:opacity-100 py-3 m-2 rounded-lg  pl-4 nav-item">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header class="w-full items-center bg-white py-3 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div style="z-index: 99999!important;" x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
        ...
        <header x-data="{ isOpen: false, isProfileOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            <div class="flex items-center justify-between">
                <a href="departments.php" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">Admin</a>
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                <a href="departments.php" class="departments flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item rounded-lg m-1">
                    <i class="material-icons mr-3">menu_book</i>
                    Departments
                </a>
                ...
                <a href="settings.php" class="settings flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item rounded-lg m-1">
                    <i class="material-icons mr-3">settings</i>
                    Settings
                </a>
                ...
                <div class="border-t border-white mt-2 pt-2">
                    ...
                    <div class="flex flex-col text-center items-center">
                        <img src="<?=$src?>" class="h-8 w-8 rounded-full border-2 border-gray-300" alt="Profile">
                        <p class="text-sm font-light"><?=ucwords(str_replace(' ', ' ', ucwords(str_replace('_', ' ', $_SESSION['role']))))?></p>
                    </div>
                    </button>
