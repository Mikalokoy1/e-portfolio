                ...
                <div  <?=$positionDisplay?> class="overflow-y-scroll px-4 sm:mt-0 mt-3 pb-4" style="height:500px ">
                    ...
                    if(count($rows) != 0) {
                        foreach ($rows as $row) {
                            ...
                            //     </div>                                
                            //     <p class="truncate md:truncate">Subject Name: <span class="font-bold  ">' . htmlspecialchars(ucwords($name)) . '</span></p>
                            //     <p  class="truncate md:truncate">Code: <span class="font-bold ">' . htmlspecialchars(strtoupper($code)) . '</span></p>
                            //         <a hidden href="documents-research.php?s='.$row['subject_id'].'&sem='.$currentSem.'&sy='.$currentYear.'"
