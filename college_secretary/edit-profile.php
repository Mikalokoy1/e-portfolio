...
if ($file_id && file_exists($filePath)) {
    ...
    if (in_array($file_type, ['application/pdf', 'image/jpeg', 'image/png', 'image/gif'])) {
        ...
        if ($file_type === 'application/pdf') {
            ...
            $file_object = '<embed src="' . htmlspecialchars($filePath) . '" type="application/pdf" style="width:100%; height:500px; max-height: 70vh;" />';
        } elseif (in_array($file_type, ['image/jpeg', 'image/png', 'image/gif'])) {
            // Images can be displayed directly
            $file_object = '<img src="' . htmlspecialchars($filePath) . '" style="width:100%; height:500px; max-height: 70vh; object-fit: contain;" />';
        }
    } else {
